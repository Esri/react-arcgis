...
export const MapBaseTests = () => (
    describe('MapBase', () => {
        ...
        describe('as a shallow component', () => {
            beforeEach(() => {
                mapBase = shallow(<MapBase scriptUri={['foo', 'bar']} userDefinedMapProperties={{}} userDefinedViewProperties={{}} />);
            });
        ...
        describe('as a mounted component', () => {
            beforeEach(() => {
                ...
                mapBase = mount(<MapBase scriptUri={['foo', 'bar']} userDefinedMapProperties={{}} userDefinedViewProperties={{}} />);
            });
            ...
            describe('esriPromise succeeds', () => {
                describe('loadMap successfully creates the map and view', () => {
                    ...
                    describe('the user has included custom event handlers', () => {
                        ...
                        beforeEach(() => {
                            mapBase = mount(<MapBase scriptUri={['foo', 'bar']} userDefinedMapProperties={{}} userDefinedViewProperties={{}} onMouseWheel={handler} />);
                        });
...
export const WebBaseTests = () => (
    describe('WebBase', () => {
        ...
        describe('as a shallow component', () => {
            beforeEach(() => {
                webBase = shallow(<WebBase id="foobar" scriptUri={['foo', 'bar']} userDefinedMapProperties={{}} userDefinedViewProperties={{}} />);
            });
        ...
        describe('as a mounted component', () => {
            beforeEach(() => {
                sinon.spy(ArcView.prototype, 'componentDidMount');
                webBase = mount(<WebBase id="foobar" scriptUri={['foo', 'bar']} userDefinedMapProperties={{}} userDefinedViewProperties={{}} />);
            });
            ...
            describe('loadMap successfully creates the map and view', () => {
                ...
                describe('the user has included custom event handlers', () => {
                    const handler = () => 'foobar';
                    beforeEach(() => {
                        webBase = mount(<WebBase id="foobar" scriptUri={['foo', 'bar']} onMouseWheel={handler} userDefinedMapProperties={{}} userDefinedViewProperties={{}} />);
                    });
